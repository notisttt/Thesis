...
public float DespawnTimer;
 ...
 void Start(){
      ...
      playerHealth = Player.GetComponent<PlayerHealthAndAttack>().PlayerHealth;
        ...
        InSightRange = Physics.CheckSphere(transform.position, SightRange, WhatIsPlayer);        //to an mporei to npc na dei ton paikti
         ...
         if (!InSightRange && !InAttackRange) {
             ...
             WildBoar.GetComponent<NavMeshAgent>().speed = 3.5f;
            Patrolling();
    ...
    m_Animator.SetBool ("IsRunning", running);
     WildBoar.GetComponent<NavMeshAgent>().speed = 7f;
    }
    ...
    private void Death(){
       ...
       WildBoar.GetComponent<NavMeshAgent>().enabled = false;
       WildBoar.GetComponent<BoxCollider>().enabled = false;
       WalkPointRange = 0;
       SightRange = 0;
       AttackSpeed = 99999;
